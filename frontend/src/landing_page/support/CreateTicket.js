        ...
        <div className='container'>
            <div className='row p-2 mt-5 mb-5'>
                ...
                <div className='col-4 p-5 mt-1 mb-1'>
                    <h4 className='mb-4'><i class="fas fa-plus-circle" style={{ marginRight: "10px" }}></i>Account Opening</h4>
                    ...
                    <br></br>
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Zerodha IDFC FIRST Bant 3-in-1 Account</a>
                    <br></br>
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Getting Started</a>
                </div>

                <div className='col-4 p-5 mt-1 mb-1'>
                    <h4 className='mb-4'><i class="fas fa-user" style={{ marginRight: "10px" }}></i>Your Zerodha Account</h4>
                ...
                <div className='col-4 p-5 mt-1 mb-1'>
                    <h4 className='mb-4'><i class="fas fa-chart-bar" style={{ marginRight: "10px" }}></i>Your Zerodha Account</h4>
                ...
                <div className='col-4 p-5 mt-1 mb-1'>
                    <h4 className='mb-4'><i class="fas fa-archive" style={{ marginRight: "10px" }}></i>Funds</h4>
                ...
                <div className='col-4 p-5 mt-1 mb-1'>
                    <h4 className='mb-4'><i class="fas fa-circle-notch" style={{ marginRight: "10px" }}></i>Console</h4>
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Reports</a>
                    <br></br>
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Ledger</a>
                    <br></br>
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Portfolie</a>
                    <br></br>
                ...
                <div className='col-4 p-5 mt-1 mb-1'>
                    <h4 className='mb-4'><i class="far fa-circle" style={{ marginRight: "10px" }}></i>Coin</h4>
                    ...
                    <br></br>
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Managing your Portfolie</a>
                    <br></br>
